...
LR_Accelerate.YuShe = {
	...
	{szName=_L["ChangGeMen-Zhi"],cd=3,jump=3,QiXue=8},
	{szName=_L["ChangGeMen-Zhi(ZhengCu)"],cd=3,jump=6,QiXue=8},
	{szName=_L["ChangGeMen-Gong"],cd=1.5,jump=1,QiXue=8},
	{szName=_L["ChangGeMen-Gong(GuangYa)"],cd=3,jump=1,QiXue=8},
