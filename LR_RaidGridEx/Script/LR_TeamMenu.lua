...
function LR_TeamMenu.MenpaiCountMenu()
	...
	for k,v in pairs (dwForceID) do
		...
		menu[#menu+1]={szOption=sformat(_L["[%s]:%2d people"],szForceName[k], LR_TeamTools.Menpai.Count[v]),rgb=LR.MenPaiColor[v],szIcon=szPath,nFrame=nFrame,szLayer = "ICON_LEFT",}
	end
	menu[#menu+1]={bDevide = true}
