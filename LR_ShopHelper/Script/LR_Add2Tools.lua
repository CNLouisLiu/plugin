...
local LR_ShopHelper_UI  = {
	...
	tWidget = {
		...
		--[[{name = "LR_ShopHelper_CheckBox03", type = "CheckBox", text = _L["Enable buy more"], x = 0, y = 80, w = 150, bDebug = true,
			default = function ()
				return LR_BuyMore.UsrData.bOn
			end,
			callback = function (enabled)
				LR_BuyMore.UsrData.bOn = enabled
			end,
		},
		--]]
	}
