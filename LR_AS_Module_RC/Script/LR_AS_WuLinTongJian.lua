...
local WLTJ_ID = {
	...
	t10R = {19219, 19220, 19276, 19277, 19278, 19279, 19280, 19281, 19282, 19283, 19284, 19285, 19286, 19287, 19288, 19289, 19290, 19291, 19292, 19293, 19294, 19295, 19296, 19297, 19298, 19299, 19300, 19661, 19662, 20147},
...
----
function _C.GrabUI()
	local frame = Station.Lookup("Normal/")
end
