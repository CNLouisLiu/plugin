	...
	tWidget = {
		{name="LR_Head_check_box",type="CheckBox",text=_L["Enable Headname"],x=0,y=0,w=150,
			...
			callback = function(m)
				...
				local border ={szOption=_L["Show Blood Border"],bCheck=true,bMCheck=false,bChecked=function() return LifeBar.ShowBorder end,fnAction=function() LifeBar.ShowBorder  = not LifeBar.ShowBorder ; LR_HeadName.SaveCommonSettings()  ;LR_HeadName.ReDrawAll()  end,}
