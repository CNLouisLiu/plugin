...
--[[		{
			name = "LR_TLHelper_UIcheck_box4", type = "CheckBox", text = _L["Show TargetLine"], x = 0, y = 220, w = 200,
			enable = function ()
				if LR.GetXinFa() == Table_GetSkillName(10225, 1) and LR_TLHelper.UsrData.on then
					return true
				else
		...
		{
			name = "LR_TLHelper_UIcheck_box5", type = "CheckBox", text = _L["Show MeLine"], x = 0, y = 250, w = 200,
			enable = function ()
				if LR.GetXinFa() == Table_GetSkillName(10225, 1) and LR_TLHelper.UsrData.on then
					return true
				else
		...
		{
			name = "LR_TLHelper_UIcheck_box6", type = "CheckBox", text = _L["Show Self"], x = 0, y = 190, w = 200,
			enable = function ()
				if LR.GetXinFa() == Table_GetSkillName(10225, 1) and LR_TLHelper.UsrData.on then
					return true
				else
